  ...
  <div>
    ...
    <div class="nav-body">
      ...
      <div class="nav-content">
        ...
        <div>
          <Carousel autoplay
                    loop>
            <CarouselItem v-for="(item, index) in marketing.CarouselItems"
                          :key="index">
    ...
    <transition name="fade">
      <div class="detail-item-panel panel-1"
        ...
        <div class="nav-detail-item">
          <span v-for="(item, index) in panelData1.navTags"
                :key="index">{{item}} > </span>
        </div>
        <ul>
          <li v-for="(items, index) in panelData1.classNav"
              :key="index"
    ...
    <transition name="fade">
      <div class="detail-item-panel panel-2"
           ...
           @mouseleave="hideDetail(2)">
        <div class="nav-detail-item">
          <span v-for="(item, index) in panelData2.navTags"
                :key="index">{{item}} > </span>
        </div>
        <ul>
          <li v-for="(items, index) in panelData2.classNav"
              :key="index"
              class="detail-item-row">
            <span class="detail-item-title">{{items.title}}
              <span class="glyphicon glyphicon-menu-right"></span>
...
export default {
  ...
  mounted () {
    ...
    this.markteting = this.$store.state.borrow.markteting
    console.error('marketing:' + this.markteting)
